...
os.environ["OPENAI_API_KEY"] = "" #enter open ai key here required for tonic_validate
...
if __name__ == "__main__":
    ...
    if args.custom_rag:
        ...
        evaluate(benchmark, query_engine.custom_query)
    else:
        query_engine = index.as_query_engine()
        evaluate(benchmark, get_llama_response)
